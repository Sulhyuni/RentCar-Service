...
//			System.out.println("1. 확인 + 2. 연결");
			...
			String sql =" select r.reNo,c.carNo, c.carModel, c.carType, c.carFuel,"
				      ...
				      + " from review r , member m , car c"
				      + "  where refNo = ? and (c.carNo = r.carNo)and (m.id = r.id) ";
//			System.out.println("3. sql - " + sql);
			// 4. 실행객체 & 데이터세팅
			pstmt = con.prepareStatement(sql);
...
//   			System.out.println("5. 실행 - result : " + result );
   			// 6. 데이터 저장 또는 표시
//   			if(result == 1) System.out.println("조회수 1 증가");
...
//			System.out.println("5. 실행 - result : " + result);
			// 6. 데이터 저장 또는 표시
//			if(result == 1)
//				System.out.println("리뷰글이 등록이 되었습니다.");
...
//			System.out.println("5. 실행");
			// 6. 데이터 저장 또는 표시
			if(result == 1) System.out.println("글이 수정되었습니다.");
			else { System.out.println("선택한 글이 없거나 본인글이 아닙니다.");
			}// end of else
		}catch (Exception e) {
			e.printStackTrace();
//			System.out.println(e.getMessage());
...
//            System.out.println("5. 실행 - result : " + result);
			// 6. 데이터 저장 또는 표시
            if(result == 1) System.out.println("글이 삭제되었습니다.");
            else { System.out.println("글이 삭제되지 않았습니다. 다시 한 번 시도해 주세요.");
            }// end of else
		} catch (Exception e) {
			e.printStackTrace();
//			System.out.println(e.getMessage());
...
//			System.out.println("5. 실행 - result : " + result);
			// 6. 데이터 저장 또는 표시
//			if(result == 1)System.out.println("답글 등록 완료");
...
//    		System.out.println("5. 실행");
    		// 6. 데이터 저장 또는 표시
//    		if(result == 1) System.out.println("순서번호 1증가");
...
//	            System.out.println("5. 실행 - result : " + result);
				// 6. 데이터 저장 또는 표시
	            if(result == 1) System.out.println("글이 삭제되었습니다.");
	            else { throw new Exception("선택한 글의 데이터가 없습니다 .");
	            }// end of else
			} catch (Exception e) {
				e.printStackTrace();
//				System.out.println(e.getMessage());
